...
export const alt = "Arc — Basketball shooting analyzer";
export const size = { width: 1200, height: 630 };
export const contentType = "image/png";

export default function BasketballOG() {
    ...
    (
      <div
        style={{
          ...
          background: "linear-gradient(135deg, #1a0a00 0%, #0a0a0a 50%, #1a1000 100%)",
          padding: "64px",
          position: "relative",
        }}
      >
        <div style={{ position: "absolute", top: "-140px", left: "-120px", width: "500px", height: "500px", borderRadius: "50%", background: "radial-gradient(circle, rgba(251,146,60,0.28), transparent 70%)", display: "flex" }} />
        <div style={{ position: "absolute", bottom: "-120px", right: "-100px", width: "420px", height: "420px", borderRadius: "50%", background: "radial-gradient(circle, rgba(245,158,11,0.20), transparent 70%)", display: "flex" }} />
        ...
        <div style={{ display: "flex", flexDirection: "column", position: "relative", marginTop: "80px", gap: "16px" }}>
          ...
          <div style={{ display: "flex", fontSize: "26px", color: "rgba(255,255,255,0.6)", marginTop: "12px" }}>
            Free throw, jump shot, three. Tuned per shot type. Apex-release detection.
          </div>
        </div>

        <div style={{ display: "flex", gap: "14px", marginTop: "auto", position: "relative" }}>
          {[
            { label: "Elbow release", value: "~180°" },
            { label: "Release angle", value: "45–55°" },
            { label: "Apex timing", value: "±120ms" },
          ].map((m) => (
